            ...
            <div className='text-white text-center pt-6 px-4 md:px-16 lg:px-52 space-y-3 py-10' style={{ background: 'rgb(149, 56, 226)' }}>
                ...
                <div className='space-x-3'>
                    <button
                        ...
                        className={`btn btn-default w-24 md:w-28 rounded-3xl ${
                            activeTab === 'cart' ? 'bg-white text-purple-700 font-bold' : 'bg-purple-600 text-white'
                        }`}
                    >
                        Cart
                    </button>
                    ...
                    <button
                        ...
                        className={`btn btn-default w-24 md:w-28 rounded-3xl ${
                            activeTab === 'wishlist' ? 'bg-white text-purple-700 font-bold' : 'bg-purple-600 text-white'
                        }`}
                    >
                        WishList
                    </button>
