...
const Banner = () => {
    return (
        <div style={{ background: 'rgb(149, 56, 226)' }} className='rounded-bl-3xl relative rounded-br-3xl mb-[300px] pb-24 md:mb-72 lg:mb-96'>
            <div className='pb-10'>
            ...
            <div className="absolute border border-white bg-white  p-2 rounded-xl left-1/2 transform -translate-x-1/2 top-full -mt-32 w-11/12 md:w-8/12 lg:h-[500px] md:h-[350px] ">
